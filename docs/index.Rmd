...
|      **[C.2]** ROC Curve AUC = 0.90950
|
| **[D]** The model does not allow for ranking of predictors in terms of variable importance.
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.91591
|
|
...
|      **[C.2]** ROC Curve AUC = 0.89992
|
| **[D]** The model does not allow for ranking of predictors in terms of variable importance.
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.97183
|
|
...
|      **[C.2]** ROC Curve AUC = 0.88642
|
| **[D]** The model does not allow for ranking of predictors in terms of variable importance.
|
| **[E]** The independent test model performance of the final model is summarized as follows:
|      **[E.1]** ROC Curve AUC = 0.90383
|
|
...
###  1.7.6 Ensemble Learner Model Development (ENL)
|
| Details.
|
|
