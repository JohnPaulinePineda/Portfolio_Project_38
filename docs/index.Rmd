...
# for hyperparameter tuning
##################################
GBM_Grid = data.frame(n.trees = c(200,400,600), 
                      interaction.depth = 6, 
                      shrinkage = 0.001,
                      n.minobsinnode = 5)
...
(MBS_GBM_Train_ROCCurveAUC <- MBS_GBM_Tune$results[MBS_GBM_Tune$results$n.trees==MBS_GBM_Tune$bestTune$n.trees,
                                                 c("ROC")])
...
plot(MBS_GBM_VarImp,
     ...
     xlGBM="Scaled VariGBMle Importance Metrics",
     ylGBM="Predictors",
     cex=2,
     origin=0,
     alpha=0.45)
