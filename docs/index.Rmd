...
##################################
AB_Grid = data.frame(mfinal = c(25,75,125), 
                     maxdepth = 6, 
                     coeflearn = "Breiman")
...
# for hyperparameter tuning
##################################
GBM_Grid = data.frame(n.trees = 500, 
                      interaction.depth = 6, 
                      shrinkage = c(0.10,0.01,0.001),
                      n.minobsinnode = 5)
...
(MBS_GBM_Train_ROCCurveAUC <- MBS_GBM_Tune$results[MBS_GBM_Tune$results$shrinkage==MBS_GBM_Tune$bestTune$shrinkage,
                                                 c("ROC")])
...
# for hyperparameter tuning
##################################
XGB_Grid = data.frame(nrounds = 500, 
                      max_depth = 6, 
                      eta = 0.3,
...
(MBS_XGB_Train_ROCCurveAUC <- MBS_XGB_Tune$results[MBS_XGB_Tune$results$gamma==MBS_XGB_Tune$bestTune$gamma,
                                                 c("ROC")])
